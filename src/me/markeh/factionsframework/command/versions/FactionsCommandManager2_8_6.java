...
public class FactionsCommandManager2_8_6 extends FactionsCommandManager {

	// ------------------------------
	//  Fields
	// ------------------------------
	
	private HashMap<FactionsCommand, FactionsCommand2_8_6Wrapper> wrappers = new HashMap<FactionsCommand, FactionsCommand2_8_6Wrapper>();
	...
	public void addCommand(FactionsCommand cmd) {
		wrappers.put(cmd, new FactionsCommand2_8_6Wrapper(cmd, cmd.aliases, cmd.requiredArguments, cmd.optionalArguments));
