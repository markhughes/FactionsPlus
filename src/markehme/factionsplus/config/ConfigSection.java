 ...
 * suggest you use the class in front of the dot ie. Config.extras.lwc.disableSomething would become Section_LWC.disableSomething which
 * supposedly is not what we want; why? because we want all configs to be seen as starting with Config; though if you don't care about this
