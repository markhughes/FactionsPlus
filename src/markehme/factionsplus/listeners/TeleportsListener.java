...
//	}
	...
	public static void init( Plugin plugin ) {
		...
		if ( (!isHomeTracking())
		        && (!Config._teleports.disallowTeleportingToEnemyLandViaEnderPeals._)) {
...
//	}
	...
	public void onTeleport( PlayerTeleportEvent event ) {
		...
		case COMMAND:
			...
			if ((Config._teleports.disallowTeleportingToEnemyLandViaHomeCommand._)&&(!Utilities.hasPermissionOrIsOp( player, permissionForHomeToEnemy ))) {
